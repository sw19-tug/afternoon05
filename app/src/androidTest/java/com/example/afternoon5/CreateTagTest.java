...
public class CreateTagTest {
    ...
    public void createTagTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTitle),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("einnkauf"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("brother milch"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatMultiAutoCompleteTextView = onView(
                allOf(withId(R.id.tagsTextView),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatMultiAutoCompleteTextView.perform(replaceText("test, spar"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.note_tags), withText("test spar "),
                        childAtPosition(
                                childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        textView.check(matches(withText("test spar ")));
    }
